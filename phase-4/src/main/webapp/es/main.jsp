...
<html>
  ...
  <body>
    ...
    <h1 class="px-1">¡Encuentra Tu Viaje!</h1>
    <main class="mx-auto max-w px-1 py-2">
    <div class="border">
    	<div class="bg-primary"><h2 class="px-1 py-05">Explora la Diversión&nbsp; 🚌💨</h2></div>
	    <form class="py-1 grid-3" method="post" action="./BUS.jsp">
			<div>
				<label class="small" for="ddate">Fecha</label>
				<input name="ddate" id="ddate" type="date" />
			</div>
			
			<div>
				<label class="small" style="display: block" for="dstation">Salida</label>
	      ...
	      <div>
	        <label class="small" style="display: block" for="astation">Llegada</label>

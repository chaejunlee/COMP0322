	...
	public static void menu(Connection conn, Statement stmt) {
		...
		public static void funct3(Connection conn, Statement stmt) {
			...
			try {
				...
				System.out.println(Routes.length()!=0 ? Routes : "Couldn't find any route");
			} catch (SQLException e) {
				System.err.println("sql error = " + e.getMessage());
				e.printStackTrace();
			}
		...
		public static void funct4(Connection conn, Statement stmt) {
			...
			try {
				...
				System.out.println(Buses.length()!=0 ? Buses.toString() : "Couldn't find any bus");
			} catch (SQLException e) {
				System.err.println("sql error = " + e.getMessage());
				e.printStackTrace();
			}
		...
		public static void funct5(Connection conn, Statement stmt) {
			...
			System.out.println("----------------------------------------------------");
			System.out.print("select sub menu and input a number of sub menu: ");
			...
			try {
				...
				System.out.println(Prices.length()!=0 ? Prices.toString() : "Couldn't find any prices");
